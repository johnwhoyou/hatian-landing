      ...
      <section className="text-center pt-20 pb-12 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center mb-3" id="download">
            <a
              href="#"
              className="inline-flex items-center justify-center gap-2 bg-text text-background px-8 py-3 rounded-full text-base font-body font-semibold hover:opacity-90 transition-opacity"
            >
